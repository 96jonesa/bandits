...
def main():
    ...
    # compute regrets
    regrets = {'exp3': get_regret(exp3.aggregate_reward, X, 1),
               'exp3ix': get_regret(exp3ix.aggregate_reward, X, 1),
               'ftl': get_regret(ftl.aggregate_reward, X, 1),
               'ucb_delta': get_regret(ucb_delta.aggregate_reward, X, 1),
               'ts_beta': get_regret(ts_beta.aggregate_reward, X, 1)}
